...
namespace DASOperations {
  ...
  // break and connect
  std::pair<ADNPointer<ADNSingleStrand>, ADNPointer<ADNSingleStrand>> CreateCrossover(ADNPointer<ADNPart> part, ADNPointer<ADNNucleotide> nt1, ADNPointer<ADNNucleotide> nt2);
}