...
class SEConnectDSDNAEditor : public SBGEditor {
...
public :
	...
	SEConnectDSDNAEditor();																													///< Builds an editor					
	virtual ~SEConnectDSDNAEditor();																											///< Destructs the editor
	...
	SEConnectDSDNAEditorGUI*											getPropertyWidget() const;												///< Returns the property widget of the editor
...
SB_REGISTER_TYPE(SEConnectDSDNAEditor, "SEConnectDSDNAEditor", "CDC75BAA-A7AD-F837-49F4-E0F14DF87181");
SB_DECLARE_BASE_TYPE(SEConnectDSDNAEditor, SBGEditor);
